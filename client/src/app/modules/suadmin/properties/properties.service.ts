...
export class PropertiesService {
  ...
  {
    return this._httpClient.get<ResultPropertiesDto>(environment.API_HOST + `api/admin/properties/getall?skip=${skip}&limit=${limit}&sort=${sort}`).pipe(
      tap((result) => {
  ...
  {
    return this._httpClient.post<ResultPropertiesDto>(environment.API_HOST + "api/admin/properties/add", data).pipe(
      tap((result) => {
      })
    );
  }
  ...
  {
    return this._httpClient.put<ResultPropertiesDto>(environment.API_HOST + "api/admin/properties/edit", data).pipe(
      tap((result) => {
      })
    );
  }
  ...
  {
    return this._httpClient.delete<ResultDeleteProperties>(environment.API_HOST + "api/admin/properties/delete/"+id).pipe(
      tap((result) => {
      })
    );
  }
