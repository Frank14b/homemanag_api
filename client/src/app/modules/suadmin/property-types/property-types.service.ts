...
export class PropertyTypesService {
  ...
  {
    return this._httpClient.get<ResultListDto>(environment.API_HOST + `api/admin/propertytypes/getall?skip=${skip}&limit=${limit}&sort=${sort}`).pipe(
      tap((result) => {
  ...
  {
    return this._httpClient.post<ResultListDto>(environment.API_HOST + "api/admin/propertytypes/add", data).pipe(
      tap((result) => {
      })
    );
  }
  ...
  {
    return this._httpClient.put<ResultListDto>(environment.API_HOST + "api/admin/propertytypes/edit", data).pipe(
      tap((result) => {
      })
    );
  }
  ...
  {
    return this._httpClient.delete<ResultDeleteDto>(environment.API_HOST + "api/admin/propertytypes/delete/"+id).pipe(
      tap((result) => {
      })
    );
  }
